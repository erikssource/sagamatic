...
Sagamatic is looking good and the test coverage is pretty decent now. I'd like to create some typescript types and see about making Sagamatic work with Redux Toolkit before going to 1.0.
